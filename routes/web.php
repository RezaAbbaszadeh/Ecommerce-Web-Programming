...
Route::get('/sellers', [SellerHomeController::class, 'index'])->name('home.sellers')
    ->middleware('seller', 'throttle:30,1');
...
Route::get('/sellers/add', [AddProductController::class, 'index'])->name('seller.add')->middleware('seller', 'throttle:60,1');
Route::post('/sellers/add', [AddProductController::class, 'store'])->middleware('seller', 'throttle:60,1');
...
Route::post('/user/cart', [CartController::class, 'store'])->name('cart.store')->middleware('customer','throttle:20,1');
